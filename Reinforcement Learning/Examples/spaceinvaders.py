...
# even the metrics!
memory = SequentialMemory(limit=100, window_length=WINDOW_LENGTH)
...
dqn = DQNAgent(model=model, nb_actions=nb_actions, policy=policy, memory=memory,
               processor=processor, nb_steps_warmup=500, gamma=.99, target_model_update=100,
...
if args.mode == 'train':
    ...
    dqn.fit(env, callbacks=callbacks, nb_steps=175, log_interval=100)
